...
const Featured = () => {
    ...
    return (
        <section ref={sectionRef} className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 md:grid-cols-3">
                {ideas.length === 0 ? (
                    Array.from({ length: 3 }).map((_, index) => (
                        <div
                            key={index}
                            className="reveal-card animate-pulse rounded-[28px] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/40 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/20"
                        >
                            <div className="mb-6 h-48 w-full rounded-[24px] bg-slate-200 dark:bg-slate-800" />
                    ...
                    ideas.map((idea) => {
                        ...
                        return (
                            <Link
                                ...
                                className="reveal-card group overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-xl shadow-slate-200/40 transition hover:-translate-y-1 hover:shadow-2xl dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/20"
                            >
                                ...
                                <div className="space-y-4 p-6">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between border-t border-slate-200 pt-4 text-sm text-slate-500 dark:border-slate-800 dark:text-slate-400">
